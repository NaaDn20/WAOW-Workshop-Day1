...
class Transaction:
    ...
    def get_all():
        ...
        for t in transactions:
            if t['TransactionDate']:
                t['TransactionDate'] = t['TransactionDate'].strftime('%Y-%m-%d %H:%M:%S')
    ...
    def create(customer_id, payment_method, items):
        ...
        try:
            ...
            cursor.execute(
                "INSERT INTO transactions (CustomerID, TotalAmount, PaymentMethod, TransactionDate) VALUES (%s, %s, %s, %s)",
                (customer_id, total_amount, payment_method, current_time)
            )
